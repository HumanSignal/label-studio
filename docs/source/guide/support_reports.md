...
Support reports give you a **safe, low-friction way to tell the HumanSignal team what’s really happening inside your Label Studio Enterprise deployment**—without sharing raw data or project configuration by hand.
...
- **No raw task data or annotations**  
  ...
  * Reports never include any PII data.
...
- **Workflow tuning and best practices**  
  ...
  - Underused features that could simplify your setup and how you are using current features
...
- Trigger manual **HTTPS** or **email** delivery (if configured)
