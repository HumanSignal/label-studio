...
You can include `main.<hash>.css` and `main.<hash>.js` files from a CDN directly. Explore `https://unpkg.com/label-studio@<LS_version>/build/static/` (for example, [0.7.3](https://unpkg.com/label-studio@0.7.3/build/static/) to find the correct JS/CSS filenames.
