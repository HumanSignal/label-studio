...
* Performance Score Calculation:
    The Performance Score column on the project Members page reflects the overall performance of annotators. This score takes into account all review actions, including annotations that were initially rejected and later accepted. The calculation is as follows:
