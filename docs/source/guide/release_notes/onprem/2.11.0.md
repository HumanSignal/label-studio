...
<div class="onprem-highlight">New ability to configure project-level roles, support for <code>X-API-Key</code>, SCIM enhancements, setting to hide the Cloud Storage page from Manager roles, and bug fixes </div>
