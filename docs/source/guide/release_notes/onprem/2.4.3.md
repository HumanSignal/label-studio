...
- AnnotationReview stats is calculated in 2 separate jobs [LSDV-4632](https://labelstudio.aha.io/features/LSDV-4632)
- Task data with dicts in array is resolved wrongly [LSDV-4621](https://labelstudio.aha.io/features/LSDV-4621)
