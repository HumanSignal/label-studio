...
meta_description: Label Studio Documentation connecting Label Studio to machine learning frameworks using the Label Studio machine earning SDK for machine learning and data science projects.
---
