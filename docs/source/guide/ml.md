...
meta_description: Label Studio Documentation about connecting Label Studio to machine learning frameworks using the Label Studio machine learning SDK for machine learning and data science projects.
---
