...
The script takes a minute or so to run and process the images. When it finishes, a file called `ocr_tasks.json` is saved in the directory where you run the script. Example output looks like the following JSON:

```json
[
  {
    "data": {
      "ocr": "http://localhost:8081/receipt_00491.png"
    },
    "predictions": [
      {
        "result": [
          {
            ...
            "type": "rectangle",
            "value": {
              "x": 17.824074074074073,
              "y": 38.73456790123457,
              "width": 40.50925925925926,
              "height": 1.1574074074074074,
              "rotation": 0
            }
          },
          {
          ...
          },
          {
            ...
            "value": {
              "x": 21.64351851851852,
              "y": 46.75925925925926,
              "width": 65.16203703703704,
              "height": 2.623456790123457,
              "rotation": 0
            }
          },
          {
          ...
          },
          {
            ...
            "type": "rectangle",
            "value": {
              "x": 24.074074074074073,
              "y": 57.098765432098766,
              "width": 62.15277777777778,
              "height": 8.641975308641975,
              "rotation": 0
            }
          },
          {
...
<img src="/images/ocr-blog/DATAMGRSCREENSHOT.png" alt="Screenshot of the data manager in Label Studio showing the OCR images sorted by prediction score." class="gif-border" />
...
2. Locate a region in the sidebar and click to update the text.
   <img src="/images/ocr-blog/UPDATEREGIONTEXT.gif" alt="Gif of updating the recognized text for a region to match teh text on the image in the Label Studio UI." class="gif-border" />
3. Click a label to select 
3. If needed, add additional regions.
   <img src="/images/ocr-blog/ADDNEWREGIONS.gif" alt="Gif of adding new regions to the image and transcribing and labeling the text in the Label Studio UI." class="gif-border" />
3. When you're done, click **Update** or **Submit** to move on to the next task.

<img src="/images/ocr-blog/OCRLONGERGIF.gif" alt="Gif of updating recognized text and adding a region in the Label Studio UI." class="gif-border" />
