    ...
    549: function(e, t, n) {
      ...
      var xn = y.m
          .model({
            ...
            points: y.m.array(gn, []),
            states: y.m.maybeNull(y.m.array(y.m.union(Jt, Ut, _n))),
      ...
      var ao = {
        ...
        oo = y.m
          .model("Relation", {
            node1: y.m.reference(y.m.union(Kn, dn, Zt, fa, En)),
            node2: y.m.reference(y.m.union(Kn, dn, Zt, fa, En)),
          })
          .actions(function(e) {
            return {
        ...
        io = y.m
          .model("RegionStore", { regions: y.m.array(y.m.safeReference(y.m.union(Kn, dn, En, Zt, fa))) })
          .actions(function(e) {
            return {
              addRegion: function(t) {
                e.regions.push(t);
      ...
      fo = {
        getData: function() {
          window.taskData && window.taskData.data
