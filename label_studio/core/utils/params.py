...
def bool_from_request(params, key, default):
    ...
    if isinstance(value, str):
        if value.lower() in ["true", "yes", "on", "1"]:
            ...
            raise ValueError(
                f'Incorrect value in key "{key}" = "{value}". '
...
def int_from_request(params, key, default):
    ...
    if isinstance(value, str):
        try:
            ...
            raise ValueError(
                f'Incorrect value in key "{key}" = "{value}". It should be digit string.'
            )
    # int
    ...
    # other
        ...
        raise ValueError(
            f'Incorrect value type in key "{key}" = "{value}". It should be digit string or integer.'
        )
...
def float_from_request(params, key, default):
    ...
    # other
        ...
        raise ValueError(
            f'Incorrect value type in key "{key}" = "{value}". It should be digit string or float.'
        )
