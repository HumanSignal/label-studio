...
def parse_input_args(input_args):
    ...
    parser_version = subparsers.add_parser("version", help="Print version info", parents=[root_parser])  # noqa: F841

    parser_user = subparsers.add_parser("user", help="Print user info", parents=[root_parser])  # noqa: F841
    ...
    parser_reset_password = subparsers.add_parser(  # noqa: F841
        "reset_password", help="Reset password for a specific username", parents=[root_parser]
    )

    parser_shell = subparsers.add_parser("shell", help="Run django shell", parents=[root_parser])  # noqa: F841
