...
from core.custom_schema_generator import CustomOpenAPISchemaGenerator
...
urlpatterns = [
    ...
    re_path(r'^label-studio-frontend/(?P<path>.*)$', serve,
    ...
    re_path(r'^react-app/(?P<path>.*)$', serve,
            kwargs={'document_root': settings.REACT_APP_ROOT, 'show_indexes': True}),
    re_path(r'^static/fonts/roboto/roboto.css$', views.static_file_with_host_resolver(
    ...
    path('docs/', RedirectView.as_view(url='/static/docs/public/guide/introduction.html',
         permanent=False), name='docs-redirect'),
