...
import label_studio.core.validators
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headers', models.JSONField(default=dict, help_text='Key Value Json of headers', validators=[label_studio.core.validators.JSONSchemaValidator({'additionalProperties': False, 'maxProperties': 10, 'patternProperties': {'^[a-zA-Z0-9-_]+$': {'type': 'string'}}, 'type': 'object'})], verbose_name='request extra headers of webhook')),
