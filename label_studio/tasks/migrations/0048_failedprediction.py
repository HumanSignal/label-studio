# Generated by Django 3.2.25 on 2024-08-13 18:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.TextField(blank=True, default='', help_text='The message explaining why generating this prediction failed', null=True, verbose_name='message')),
                ...
                ('model_version', models.TextField(blank=True, default='', help_text='A string value that for model version that produced the failed prediction. Used in both live models and when uploading offline predictions.', null=True, verbose_name='model version')),
