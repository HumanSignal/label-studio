...
from core.utils.common import get_object_with_check_and_log, load_func, retry_database_locked
...
class AnnotationSerializer(DynamicFieldsMixin, ModelSerializer):
    ...
    def to_representation(self, instance):
        annotation = super().to_representation(instance)
    ...
    def get_fields(self):
        ...
        if self.context.get("export_mode", False):
            excluded += ["created_username", "created_ago", "task", "was_cancelled", "ground_truth", "result_count"]
