...
def get_not_solved_tasks_qs(
    ...
    # This prevents NEW annotators from getting tasks that are already at their annotation limit
    # Note: Only applies to annotators - managers and admins can access all tasks
    ...
    lse_project = getattr(project, 'lse_project', None)
    if lse_project and getattr(lse_project, 'strict_task_overlap', False) and user.is_annotator:
