...
class Project(models.Model):
    ...
    evaluate_predictions_automatically = models.BooleanField(_('evaluate predictions automatically'), default=True, help_text='Evaluate predictions automatically on the task loading')
