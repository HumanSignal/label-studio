...
from projects.models import Project, ProjectManager, ProjectSummary
from projects.serializers import ProjectLabelConfigSerializer, ProjectSerializer, ProjectSummarySerializer
...
from tasks.models import Annotation, Prediction, Task, TaskLock
...
class ProjectListAPI(generics.ListCreateAPIView):
    ...
    def perform_create(self, ser):
        try:
            project = ser.save(organization=self.request.user.active_organization)  # noqa: F841
