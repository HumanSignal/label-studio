...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {
                "title": "111",
                "label_config": '<View><Text name="my_text" value="$text"/><Choices name="my_class" toName="my_text"><Choice value="pos"/><Choice value="neg"/></Choices></View>',  # noqa: E501
            },  # noqa
            None,
            201,
        ),
        ...
        (
            {
                "title": "111",
                "label_config": '<View><Text name="my_text" value="$text"/><Choices name="my_class" toName="unexisted"><Choice value="pos"/><Choice value="neg"/></Choices></View>',  # noqa: E501
            },  # noqa
        ...
        (
            {
                "title": "111",
                "label_config": '<View><Text name="my_text" value="$text"/><Choices name="my_class"><Choice value="pos"/><Choice value="neg"/></Choices></View>',  # noqa: E501
            },  # noqa
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # TODO: this should instead of next one,
        # but "configured_project" fixture doesn't update project.summary with data columns
        # invalid column
        # (
        #     {"label_config": "<View><Text name=\"my_text\" value=\"$text\"/><Choices name=\"my_class\" toName=\"my_text\"><Choice value=\"pos\"/><Choice value=\"neg\"/></Choices></View>"}, # noqa: E501
        #     # noqa
...
def test_creating_activating_new_ml_backend(
    client_and_token, configured_project, external_status_code, current_active_ml_backend_url, ml_backend_call_count
):
