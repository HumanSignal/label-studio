...
TIMEOUT_DUPLICATE_MODEL = float(get_env('TIMEOUT_DUPLICATE_MODEL', 1))
TIMEOUT_DELETE = float(get_env('TIMEOUT_DELETE', 1))
TIMEOUT_TRAIN_JOB_STATUS = float(get_env('TIMEOUT_TRAIN_JOB_STATUS', 1))
