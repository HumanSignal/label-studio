...
from core.utils.common import batch, bool_from_request, get_object_with_check_and_log
...
from .serializers import ExportCreateSerializer, ExportDataSerializer, ExportSerializer
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description=(
            ...
            ```bash
            """
            f"curl -X GET {settings.HOSTNAME or 'https://localhost:8080'}/api/projects/{{id}}/export?exportType=JSON -H 'Authorization: Token abc123' -o 'annotations.json'"  # noqa: E501
            """
            ```
            ...
            ```bash
            """
            f"curl -X GET {settings.HOSTNAME or 'https://localhost:8080'}/api/projects/{{id}}/export?exportType=JSON&download_all_tasks=true -H 'Authorization: Token abc123' -o 'annotations.json'"  # noqa: E501
            """
            ```
            To export specific tasks with IDs of 123 and 345,
            run the following from the command line:
            ```bash
            """
            "curl -X GET {settings.HOSTNAME or 'https://localhost:8080'}/api/projects/{{id}}/export?ids[]=123\\&ids[]=345 -H 'Authorization: Token abc123' -o 'annotations.json'"  # noqa: E501
            """
            ```
            """
        ),
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        Get the `export_pk` from the response of [Create new export](/api#operation/api_projects_exports_create)
