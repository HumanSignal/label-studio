...
_api_projects_urlpatterns = [
    ...
    path('<int:pk>/import/huggingface', api.HuggingFaceImportAPI.as_view(), name='project-import-huggingface'),
    ...
    path('<int:pk>/file-uploads/count-tasks', api.FileUploadTaskCountAPI.as_view(), name='project-file-upload-count-tasks'),
]
