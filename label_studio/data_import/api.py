    ...
    decorator=swagger_auto_schema(
        ...
        operation_description="""
            ...
            **Note:** Imported data is verified against a project *label_config* and must
            ...
            Update this example to specify your authorization token and Label Studio instance host,
            ...
            ### 3\\. **POST with URL**
            You can also provide a URL to a file with labeling tasks.
            Supported file formats are the same as in option 2.
