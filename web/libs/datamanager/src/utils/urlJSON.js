...
// Uses gzip to minimize the size of the serialized data

import { gzip, ungzip } from 'pako'
import { fromUint8Array, toUint8Array } from 'js-base64'
import { packJSON } from './packJSON';

export const deserializeJsonFromUrl = (s) => {
...
export const serializeJsonForUrl = (s) => fromUint8Array(gzip(JSON.stringify(s)), true)
