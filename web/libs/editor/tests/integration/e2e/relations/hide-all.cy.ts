...
describe('Relations- Hide all relations', () => {
        beforeEach(() => {
        ...
        it('should exist and be disabled without existed relations', () => {
                Relations.hideAllRelationsButton.should('be.visible').should('be.disabled');
        });
        ...
        it('should hide all relations', () => {
                ...
                Relations.hideAllRelationsButton.click();
        ...
        it('should show all relations', () => {
                ...
                Relations.hideAllRelationsButton.click();
                Relations.hasHiddenRelations(3);
                Relations.showAllRelationsButton.click();
                Relations.hasHiddenRelations(0);
        });
        ...
        it('should have tooltip for hide action', () => {
                ...
                Tooltip.hasText('Show all relations');
        });
});
