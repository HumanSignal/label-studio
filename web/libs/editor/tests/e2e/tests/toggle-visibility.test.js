...
const ALL_VISIBLE_SELECTOR =
  ".lsf-entities__visibility:not(.lsf-entities__visibility_hidden)";
const ALL_HIDDEN_SELECTOR =
  ".lsf-entities__visibility.lsf-entities__visibility_hidden";
const ONE_VISIBLE_SELECTOR =
  ".lsf-region-item__toggle.lsf-region-item__toggle_active";
const ONE_HIDDEN_SELECTOR =
  ".lsf-region-item__toggle:not(.lsf-region-item__toggle_active)";
...
const annotations = [
  {
    ...
    lead_time: 15.053,
    result: [
      createRegion("tag", "rectanglelabels", {
...
Scenario(
  "Checking mass toggling of visibility",
...
Scenario(
  "Hiding bulk visibility toggle",
  ({ I, AtImageView, AtLabels, AtSidebar }) => {
    I.amOnPage("/");
