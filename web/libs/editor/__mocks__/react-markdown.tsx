 ...
 *
 * react-markdown is ESM-only. We don't need to test the actual markdown rendering
 * in unit tests — we only need to verify that our components correctly pass content
