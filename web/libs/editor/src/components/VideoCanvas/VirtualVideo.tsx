...
type VirtualVideoProps = DetailedHTMLProps<
...
export const canPlayUrl = async (url: string) => {
  ...
  const fileType = (pathName.split(".").pop() ??
    "") as keyof typeof mimeTypeMapping;
  ...
  const supported =
    isBinary(fileMimeType) ||
    (!!fileMimeType && video.canPlayType(fileMimeType) !== "");
...
export const VirtualVideo = forwardRef<HTMLVideoElement, VirtualVideoProps>(
  (props, ref) => {
