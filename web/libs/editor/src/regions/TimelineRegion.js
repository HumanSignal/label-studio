...
const Model = types
  ...
  .actions((self) => ({
     ...
     * @property {object[]} value.ranges array of ranges, each range is an object with start and end properties
     * @property {string[]} [value.timelinelabels] regions are created only by TimelineLabels, so they are here
     */
