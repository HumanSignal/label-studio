...
const mockValidateText = vi.fn(() => true);
const mockUpdateLeadTime = vi.fn();
const mockCountTime = vi.fn();

vi.mock("../../tags/control/TextArea/TextArea", () => {
...
vi.mock("../../components/HtxTextBox/HtxTextBox", () => ({
