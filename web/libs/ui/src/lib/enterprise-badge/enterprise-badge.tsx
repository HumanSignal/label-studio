...
export const EnterpriseBadge: FC<EnterpriseBadgeProps> = ({ className, filled, compact }) => {
  return (
    <div className={clsx(styles.badge, { [styles.filled]: filled, [styles.compact]: compact }, className)}>
