    ...
    <Block name="prediction-settings">
      <Elem name={'wrapper'}>
        ...
        {loaded && versions.length == 0 && <EmptyState icon={<IconEmptyPredictions/>}
                                                       ...
                                                       footer={<div>Need help?<br/><a
                                                         href="https://labelstud.io/guide/predictions" target="_blank">Learn
                                                         more on how to upload predictions in our docs</a></div>}/>
        }
