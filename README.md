...
| [label-studio-frontend](https://github.com/heartexlabs/label-studio-frontend) | React and JavaScript frontend, can run standalone in a web browser or be embedded into your application | 
